function getTranslation(e, r) {
    let n = [
        ...
        ["footerHigh", 
            ...
            "Sichere on-device Verschlüsselung! Version " + getVersion() + "<br>Keine Daten werden gesendet. Keine Cookies = kein Tracking. Kein Logging.", 
            "设备上的安全加密！版本 " + getVersion() + "<br>没有数据发送。没有饼干。没有跟踪。没有记录。", 
            "Безопасное шифрование на устройстве! Version " + getVersion() +"<br>Никаких данных не отправляется. Никаких файлов cookie.", 
            "Encriptación segura en el dispositivo! Versión " + getVersion() + "<br> No se envían datos. No hay cookies. No hay rastreo. No hay registro.",
            "Cryptage sécurisé sur le dispositif! Version "+ getVersion() + "<br>Aucune donnée envoyée. Pas de cookies. Pas de suivi. Pas d'enregistrement.", 
            "", 
            ""],
        ["inputText", 
            "message", 
