function getTranslation(e, r) {
    let n = [
        ...
        ["explanation", 
            ...
            ""],
        ["footerHigh", 
            "Secure on device AES encryption! Version " + getVersion() + "<br>No data sent. No cookies. No tracking. No logging.<br><hr>🌌 Switch language:", 
            "Sichere AES Verschlüsselung auf dem Gerät! Version " + getVersion() + "<br>Keine Daten werden gesendet. Keine Cookies. Kein Tracking. Kein Logging.<br><hr>🌌 Switch language:", 
