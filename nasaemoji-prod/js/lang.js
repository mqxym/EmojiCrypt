function getTranslation(e, r) {
    let n = [
        ...
        ["footerHigh", 
            ...
            "保护设备 AES/BF 加密！版本 " + getVersion() + "<br>没有数据发送。没有饼干。没有跟踪。没有记录。反暴力/量子/ASIC<br>, Switch Language:", 
            "Безопасное шифрование AES/BF на устройстве! Version" + getVersion() +"<br>Никаких данных не отправляется. Никаких файлов cookie. Никакого отслеживания. Никакого протоколирования. <br> Switch language:", 
            "Encriptación segura en el dispositivo AES/BF. Versión " + getVersion() + "<br> No se envían datos. No hay cookies. No hay rastreo. No hay registro. <br> Anti-Bruteforce/Quantum/ASIC<br> Switch language:",
            "", 
            "", 
            ""],
        ["inputText", 
